...
extension Favorite : Hashable {
    ...
    public func hash(into hasher: inout Hasher) {
        ...
        hasher.combine(imageCompilation)
        hasher.combine(service)
    }
}

// Transferable extension is conformed to in the project itself as it needs a high sdk version and a project-specific UTType
